    ...
    <section className="section grid-dots">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl">
          <div className="mb-4 inline-flex rounded-md bg-ink px-4 py-2">
            <span className="text-sm font-semibold text-champagne">{copy.eyebrow}</span>
          </div>
          <h2 className="section-title">{copy.title}</h2>
          <p className="section-subtitle">{copy.subtitle}</p>
        </div>
        <div className="mt-8 max-w-5xl sm:mt-10">
          <div className="rounded-lg border border-ink/10 bg-white p-4 shadow-soft sm:p-6 md:p-8">
